...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeStoreBundle', ($this->targetDirs[2].'/Resources/AcmeStoreBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeStoreBundle', ($this->targetDirs[3].'/src/Acme/StoreBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeUserBundle', ($this->targetDirs[2].'/Resources/AcmeUserBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeUserBundle', ($this->targetDirs[3].'/src/Acme/UserBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_576a4d83333c48cece9b5b7e0355de55443c882096c1542c121b989bf61cf1e1');
    ...
    protected function getDoctrineMongodb_Odm_DefaultConfigurationService()
    {
        ...
        $b->setNamespace('sf2mongodb_default_576a4d83333c48cece9b5b7e0355de55443c882096c1542c121b989bf61cf1e1');

        $c = new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Acme/StoreBundle/Document'), 1 => ($this->targetDirs[3].'/src/Acme/UserBundle/Document')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($c, 'Acme\\StoreBundle\\Document');
        $d->addDriver($c, 'Acme\\UserBundle\\Document');
        ...
        $instance->setDocumentNamespaces(array('AcmeStoreBundle' => 'Acme\\StoreBundle\\Document', 'AcmeUserBundle' => 'Acme\\UserBundle\\Document'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Acme\\UserBundle\\Document\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Acme\\UserBundle\\Document\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine_mongodb')->getManager(NULL), 'Acme\\UserBundle\\Document\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'DoctrineMongoDBBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'AcmeStoreBundle', 9 => 'AcmeUserBundle', 10 => 'FOSUserBundle', 11 => 'AsseticBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
